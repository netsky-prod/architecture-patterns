...
- SKILL.md: body < 500 lines. Pattern files: 40-80 lines, sections in this order: One-liner, Symptoms, Solution, When to use, When NOT to use, Trade-offs, Common pitfalls, Related.
